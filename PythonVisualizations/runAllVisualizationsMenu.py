...
PREFERRED_ARRANGEMENT = [
    ['Group 1', ['Array', 'OrderedArray']],
    ['Group 2', ['SimpleArraySort']],
    ['Group 3', ['Stack', 'Queue', 'PriorityQueue', 'InfixCalculator']],
    ['Group 4', ['LinkedList', 'OrderedList']],
    ['Group 5', [ 'TowerOfHanoi', 'Mergesort']],
    ['Group 6', ['AdvancedArraySort']],
    ['Group 7', ['BinaryTree']],
    ['Group 8', ['Tree234']],
    ['Group 9', ['AVLTree', 'RedBlackTree']],
    ['Group 10', ['HashTableOpenAddressing', 'HashTableChaining']],
    ['Group 11', ['PointQuadtree']],
    ['Group 12', ['Heap']],
    ['Group 13', ['Graph']],
